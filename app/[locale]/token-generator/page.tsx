        ...
        <CardContent className="space-y-6">
          <div className="grid grid-cols-2 gap-4">
            <div className="flex items-center justify-between">
              ...
              <Switch id="uppercase" checked={withUppercase} onCheckedChange={setWithUppercase} />
            </div>
            ...
            <div className="flex items-center justify-between">
              ...
              <Switch id="numbers" checked={withNumbers} onCheckedChange={setWithNumbers} />
            </div>
            ...
            <div className="flex items-center justify-between">
              ...
              <Switch id="lowercase" checked={withLowercase} onCheckedChange={setWithLowercase} />
            </div>
            ...
            <div className="flex items-center justify-between">
              ...
              <Switch id="symbols" checked={withSymbols} onCheckedChange={setWithSymbols} />
            </div>
          </div>
